...
define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName7f8210e8-5216-49f4-8e00-5315589257a5",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT86df7c53-5894-4dca-a042-fa4655273e1f",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATd25c7c8f-2f9f-47de-914b-52c620faa73e",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			/* Metadata to add the custom button to the page. */
			{
                ...
                "values": {
                    ...
                    "itemType": Terrasoft.ViewItemType.BUTTON,
                    "caption": {bindTo: "Resources.Strings.RunWebServiceButtonCaptionwv"},
			...
			{
				"operation": "insert",
				"name": "LOOKUP5846f994-72eb-4301-b4b0-355da7146bd6",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP958bd4c6-add8-4534-b6bd-031ff5a4dd27",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
